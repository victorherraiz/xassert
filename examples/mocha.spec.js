...
describe('Mocha Examples', function () {
  it('should allow simple assertions', function () {
    ...
    assert({ a: 2, b: [3, 6] })
      .includesProperty('a', it => it.isANumber())
      .includesProperty('b', it => it.isAnArray().every(it => it.isANumber()))
  })
